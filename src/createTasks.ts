...
export const createTasks = (tasks: task[]): void => {
	const swimLane = {
		todo: document.querySelectorAll<HTMLElement>(".swim-lane")[0],
		doing: document.querySelectorAll<HTMLElement>(".swim-lane")[1],
		done: document.querySelectorAll<HTMLElement>(".swim-lane")[2],
	};
